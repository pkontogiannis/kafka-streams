...
/**
  ...
  * kafka-topics --create --zookeeper kafka:2181 --replication-factor 1 --partitions 1 --topic test
  * bin/kafka-topics --zookeeper kafka:2181 --partitions 1 --replication-factor 1 --topic test --create
  */
object WordCount extends App {
  ...
  config.put(StreamsConfig.COMMIT_INTERVAL_MS_CONFIG, StreamSettings.commitIntervalMillis)
